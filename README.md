# Seat-occupancy-detection-through-mobile-camera
It is a chair / seat filled or empty detection in a specific area through mobile camera
...
1. We need to download some useful libraries and frameworks to be used:
   * cv2, os, urllib, mediapipe
2. We need to download the iVCam software in both mobile and PC.
3. We need to connect both the devices to the same network to connect both with each other.
